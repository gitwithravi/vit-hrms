...
use App\Http\Controllers\Attendance\TimesheetReportController;
...
Route::get('attendance/timesheets/report', TimesheetReportController::class)->middleware('permission:timesheet:export');
