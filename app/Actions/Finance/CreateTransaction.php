...
class CreateTransaction
{
    ...
    {
        $numberPrefix = config('config.finance.transaction_number_prefix');
        $numberSuffix = config('config.finance.transaction_number_suffix');
        $digit = config('config.finance.transaction_number_digit');
