...
class WorkShiftRequest extends FormRequest
{
    ...
    public function withValidator($validator)
    {
        ...
        $validator->after(function ($validator) {
            ...
            foreach ($this->records as $index => $record) {
                ...
                if (! $isHoliday && $isOvernight && $startTime <= $endTime) {
                    $validator->errors()->add("records.{$index}.start_time", __('attendance.work_shift.overnight_start_time_should_greater_than_end_time'));
                }
    ...
    public function attributes()
    {
        return [
            ...
            'records.*.is_holiday' => __('attendance.work_shift.props.is_holiday'),
            'records.*.is_overnight' => __('attendance.work_shift.props.is_overnight'),
