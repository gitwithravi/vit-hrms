            ...
            <div class="col-sm-10 wdt-purchase-code-master-detail p-l-0">
                ...
                <h4 class="c-title-color m-b-4 m-t-0">
                    ...
                    <i class="wpdt-icon-info-circle-thin" data-toggle="tooltip" data-placement="right"
                       title="<?php esc_attr_e('If your brought the plugin directly on our website, enter TMS Store purchase code to enable auto updates.', 'wpdatatables'); ?>"></i>
                </h4>
                <!-- /TMS Store Purchase Code Heading -->
                        ...
                        <div class="col-sm-11 p-r-0 wdt-purchase-code-store-master-detail-wrapper">
                            <div class="fg-line">
                                <input type="text" name="wdt-purchase-code-store-master-detail"
                                       ...
                                       placeholder="<?php esc_attr_e('Please enter your Master-Detail TMS Store Purchase Code', 'wpdatatables'); ?>"
                                       value=""
                                />
                            </div>
                        </div>
